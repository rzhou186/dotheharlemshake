<?php
  ...
  shell_exec('sudo '.$ffmpeg.' -i '.'/home/scriptcam/'.$file1.$file2.'.mpg'.' -i '.$audio.' -ab 192k -vcodec copy -shortest '.'/var/www/dotheharlemshake/'.$file1.$file2.'1.mpg');
  unlink('/var/www/dotheharlemshake/'.$file1.$file2.'.mpg');
